...
const Home = () => (
  <div className="home">
    ...
    <h3 className='homepage-description'>Each of the tiles below will bring you to a gallery of photography by genre. Within each gallery, each image contains a "Like" button. Please click the "Like" button for any images that are portfolio worthy. These images' filenames will be added to a dropdown container at the top left. When you are finished reviewing and liking images, please click the "liked" dropdown to see the filename list. If it looks correct, please click "send" to send the filenames to my email. <br /> <br /> Thank you for assisting me with my portfolio curation! <FontAwesomeIcon icon={faFaceSmileBeam} /></h3>
